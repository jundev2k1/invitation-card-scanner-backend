...
-- 3. Full-text Search Trigger (Tương tự bảng Users)
CREATE OR REPLACE FUNCTION event_categories_search_vector_trigger() RETURNS trigger AS $$
BEG
  NEW.search_vector :=
...
-- 4. Functions
CREATE OR REPLACE FUNCTION get_event_category_by_id(p_id VARCHAR)
...
BEGIN
  INSERT INTO event_categories (
    id, parent_id, name, slug, description, image_url, "status", sort_order, level
  )
  VALUES (
    p_id, 
    p_parent_id, 
